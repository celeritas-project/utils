...
// Class Description:
//
// Muon-Catalyzed deuterium-tritium fusion process class header
//

#ifndef MuonCatalyzedDTFusion_h
#define MuonCatalyzedDTFusion_h 1
...
class MuonCatalyzedDTFusion : public VMuonCatalyzedFusionProcess

{
  public:
    explicit MuonCatalyzedDTFusion(G4String const& name
                                   = "MuonCatalyzedDTFusion");
  ...
  private:
    ...
    MuonCatalyzedDTFusion& operator=(MuonCatalyzedDTFusion const& right);
    MuonCatalyzedDTFusion(MuonCatalyzedDTFusion const&);
    ...
    // Formation rate vs. temperature function, Spin F=0
    G4DataInterpolation* lambdaHD0Interpolator;
    G4DataInterpolation* lambdaDD0Interpolator;
    G4DataInterpolation* lambdaDT0Interpolator;

    // Formation rate vs. tempeature function, Spin F=1
    G4DataInterpolation* lambdaHD1Interpolator;
    G4DataInterpolation* lambdaDD1Interpolator;
    G4DataInterpolation* lambdaDT1Interpolator;
};
