...
// Class Description:
//
// Muon-Catalyzed deuterium-deuterium fusion process class header
//

#ifndef MuonCatalyzedDDFusion_h
#define MuonCatalyzedDDFusion_h 1
...
class MuonCatalyzedDDFusion : public VMuonCatalyzedFusionProcess
{
  public:
    explicit MuonCatalyzedDDFusion(G4String const& name
                                   = "MuonCatalyzedDDFusion");
  ...
  private:
    ...
    MuonCatalyzedDDFusion& operator=(MuonCatalyzedDDFusion const& right);
    MuonCatalyzedDDFusion(MuonCatalyzedDDFusion const&);
    ...
    G4DataInterpolation* lambdaDDmuFromSpinOneHalfInterpolator;
    G4DataInterpolation* lambdaDDmuFromSpinThreeHalvesInterpolator;
};
